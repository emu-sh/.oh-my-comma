...
from py_utils.emu_utils import run, error, success, warning, info, is_affirmative, check_output, most_similar, input_with_options
    ...
    if branch is None:  # user hasn't specified a branch, use remote's default branch
      ...
      if branch not in remote_branches:
        ...
        if close_branches[0][1] > 0.5:
          ...
          info('Unknown branch, using most similar: {}'.format(branch))
        else:
